...
// 인스타그램 스토리 이미지 생성 (Vercel용) - Canvas API 복원 + 모바일 호환성 개선
app.post('/api/generate-story-image', authenticateToken, async (req, res) => {
  try {
    ...
    // 플랫폼 아이콘 그리기 (이모지 대신 텍스트 사용)
    const platformIcon = playlist.platform === 'youtube' ? 'MUSIC' : 'AUDIO';
    ctx.font = 'bold 36px "Helvetica Neue", "Arial", "Helvetica", "sans-serif"';
    ctx.fillStyle = '#ffffff';
    ctx.textAlign = 'center';
    ctx.textBaseline = 'middle';
    ...
    // 플랫폼 정보 그리기
    ctx.font = 'bold 28px "Helvetica Neue", "Arial", "Helvetica", "sans-serif"';
    ctx.fillStyle = '#ffffff';
    ctx.textAlign = 'center';
    ctx.textBaseline = 'middle';
    ...
    // Vault 로고 그리기
    ctx.font = 'bold 48px "Helvetica Neue", "Arial", "Helvetica", "sans-serif"';
    ctx.fillStyle = '#ffffff';
    ctx.textAlign = 'center';
    ctx.textBaseline = 'middle';
    ...
    // 링크 안내 텍스트 그리기
    ctx.font = 'bold 24px "Helvetica Neue", "Arial", "Helvetica", "sans-serif"';
    ctx.fillStyle = '#ffffff';
    ctx.textAlign = 'center';
    ctx.textBaseline = 'middle';
